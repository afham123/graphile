...
COMMENT ON TABLE learn.card IS 'An individual person flash card object.';
COMMENT ON COLUMN learn.card.id IS 'A primary unique identifier for the flash card.';
